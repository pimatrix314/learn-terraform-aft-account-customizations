locals {
  ...
  tgw_aws_asn    = 65532
  root_ou_arn    = "arn:aws:organizations::${module.aft_account_list.param_name_values["${local.ssm_parameter_path_account_list}account-lz2-master"]}:organization/${data.aws_ssm_parameter.master_org_id.value}"
